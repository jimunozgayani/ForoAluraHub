...
import com.aluracursos.ForoAluraHub.domain.usuarios.*;
...
public class UsuarioController {
    ...
    @PostMapping
    public ResponseEntity<DatosListadoUsuarios> agregarUsuario(@RequestBody @Valid DatosRegistroUsuarios datosRegistroUsuario, UriComponentsBuilder uriComponentsBuilder) {
    ...
    @PutMapping
    @Transactional
    public ResponseEntity<DatosListadoUsuarios> actualizaUsuario(@RequestBody @Valid DatosActualizarUsuarios datosActualizarUsuario) {
