...
import com.aluracursos.ForoAluraHub.domain.respuestas.DatosActualizarRespuestas;
import com.aluracursos.ForoAluraHub.domain.respuestas.DatosListadoRespuestas;
import com.aluracursos.ForoAluraHub.domain.respuestas.DatosRegistroRespuestas;
import com.aluracursos.ForoAluraHub.domain.respuestas.RespuestaService;
...
public class RespuestaController {
    ...
    @PutMapping
    public ResponseEntity<DatosListadoRespuestas> actualizarRespuesta(@RequestBody @Valid DatosActualizarRespuestas datosActualizarRespuesta) {
