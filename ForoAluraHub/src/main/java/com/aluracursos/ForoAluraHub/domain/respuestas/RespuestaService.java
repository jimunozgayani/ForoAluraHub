...
import com.aluracursos.ForoAluraHub.domain.topicos.TopicoRepository;
...
public class RespuestaService {
    ...
    public DatosListadoRespuestas agregarRespuesta(DatosRegistroRespuestas datosRegistroRespuesta) {
        Topico topico;
        Usuario usuario;
    ...
    @Transactional
    public DatosListadoRespuestas actualizaRespuesta(DatosActualizarRespuestas datosActualizarRespuesta) {
